...
module.exports = {
    ...
    execute(client, message, args) {
        const credit_embed = new MessageEmbed()
            ...
            .addField('thank you to:', `[IgorKowalczyk](https://github.com/IgorKowalczyk) for some commands!`)
            .addField('libraries used:', "discord.js, fs, covidapi, discord-player, imageapi.js, mongoose, weather.js")
